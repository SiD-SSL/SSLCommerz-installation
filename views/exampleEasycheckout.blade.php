...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <div class="py-5 text-center">
            ...
            <p class="lead">Below is an example form built entirely with Bootstrap’s form controls. We have provided this sample form for understanding EasyCheckout (Popup) Payment integration with SSLCommerz.</p>
        </div>
