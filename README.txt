					FOLLWING = [ https://github.com/sslcommerz/SSLCommerz-Laravel ]
...
STEP 4 => Copy "Middleware/VerifyCsrfToken" middleware and paste it to the Directory is "App/Http/Middleware/"
	  ...
	  [ * ALTERNATE * ] Or you can just pase the exceptions on this directory "App/Http/Middleware/VerifyCsrfToken"
